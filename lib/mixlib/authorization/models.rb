...
require 'mixlib/authorization/models/organization_internal'
...
require 'mixlib/authorization/models/sandbox'
require 'mixlib/authorization/models/environment'
require 'mixlib/authorization/models/organization_user'